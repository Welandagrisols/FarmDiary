...
export default function MoreScreen() {
  ...
  return (
    <ScrollView
      ...
      contentContainerStyle={{ paddingTop: topPadding + 8, paddingBottom: bottomPadding + 100 }}
    >
      ...
      <View style={styles.section}>
        ...
        <View style={styles.menuCard}>
          <MenuRow
            ...
            label="Inventory"
            subtitle="Track stock levels and usage"
            color={COLORS.teal}
          ...
          <MenuRow
            icon={<Ionicons name="eye-outline" size={22} color={COLORS.amber} />}
            label="Observations"
            subtitle="Daily scouting notes"
            color={COLORS.amber}
      ...
      <View style={styles.section}>
        ...
        <View style={styles.statsGrid}>
          <View style={styles.statCard}>
            ...
            <Text style={styles.statValue}>{activityLogs.length}</Text>
          ...
          <View style={styles.statCard}>
            <Ionicons name="eye-outline" size={22} color={COLORS.amber} />
            <Text style={styles.statValue}>{observations.length}</Text>
            <Text style={styles.statLabel}>Observations</Text>
          </View>
          <View style={[styles.statCard, { backgroundColor: lowStockCount > 0 ? COLORS.amberLight : COLORS.primarySurface }]}>
            <Ionicons name="warning-outline" size={22} color={lowStockCount > 0 ? COLORS.amber : COLORS.primary} />
            <Text style={[styles.statValue, { color: lowStockCount > 0 ? COLORS.amber : COLORS.primary }]}>{lowStockCount}</Text>
